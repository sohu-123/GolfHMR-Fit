...
class SAM3DBodyEstimator:
    def __init__(
        ...
        # Thresholds and soft limits for wrist/hand constraints
        self.thresh_wrist_angle = 1.4
        self.hand_rot_consistency_thresh = 0.6  # radians: bilateral rotation consistency
        self.forearm_align_thresh = 0.5  # radians: hand-forearm axis alignment
        self.wrist_soft_limit = 1.0  # radians: soft limit start
        self.wrist_soft_scale = 0.5  # blending scale for soft wrist constraint
    ...
    def process_one_image(
        ...
        outputs = self.model.run_inference(
            ...
            hand_rot_consistency_thresh=self.hand_rot_consistency_thresh,
            forearm_align_thresh=self.forearm_align_thresh,
            wrist_soft_limit=self.wrist_soft_limit,
            wrist_soft_scale=self.wrist_soft_scale,
        )
